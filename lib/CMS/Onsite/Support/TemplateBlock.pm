...
package CMS::Onsite::Support::TemplateBlock;
...
sub block_mismatch {
    ...
    my $begin = $self->{NAME} || '';
    die "CMS::Onsite::Support::NestedTemplate: " .
    ...
    while (@$tokens) {
		...
		if ($token eq $marker) {
            ...
            if ($cmd eq 'end') {
				...
				my $ucmd = ucfirst($cmd);
                my $pkg =  "CMS::Onsite::Support::${ucmd}TemplateBlock";
...
sub render {
    ...
    my $bin =  CMS::Onsite::Support::Bin->new($data);
...
#----------------------------------------------------------------------
package CMS::Onsite::Support::TemplateSubBlock;

use base qw(CMS::Onsite::Support::TemplateBlock);
...
sub unparse {
    ...
    my $source = $self->CMS::Onsite::Support::TemplateBlock::unparse();
    return $self->decorate($source);
}

#----------------------------------------------------------------------
package CMS::Onsite::Support::TemplateControlBlock;

use base qw(CMS::Onsite::Support::TemplateSubBlock);
...
#----------------------------------------------------------------------
package CMS::Onsite::Support::BeginTemplateBlock;
...
sub render {
    ...
    my $result = $self->CMS::Onsite::Support::TemplateBlock::render($bin);
    return $self->decorate($result);
}

#----------------------------------------------------------------------
package CMS::Onsite::Support::IfTemplateBlock;

use base qw(CMS::Onsite::Support::TemplateControlBlock);
...
#----------------------------------------------------------------------
package CMS::Onsite::Support::SetTemplateBlock;

use base qw(CMS::Onsite::Support::BeginTemplateBlock);
...
#----------------------------------------------------------------------
package CMS::Onsite::Support::WithTemplateBlock;
...
#----------------------------------------------------------------------
package CMS::Onsite::Support::UnlessTemplateBlock;

use base qw(CMS::Onsite::Support::IfTemplateBlock);
...
package CMS::Onsite::Support::Bin;
...
sub get {
    ...
    if (exists $self->{$name}) {
        $val = $self->{$name};
        if (defined $rest) {
            my $bin = CMS::Onsite::Support::Bin->new($val);
