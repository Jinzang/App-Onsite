...
package CMS::Onsite::Support::CachedFile;
...
CMS::Onsite::Support::CachedFile saves the parsed representation of a file

=head1 SYNOPSIS

	use CMS::Onsite::Support::CachedFile;
    my $obj = CMS::Onsite::Support::CachedFile->new();
...
This is the default class used for caching CMS::Onsite::Support::ConfigFile
