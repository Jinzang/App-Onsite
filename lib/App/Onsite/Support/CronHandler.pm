...
package App::Onsite::Support::CronHandler;
...
App::Onsite::Support::CronHandler runs an object as a cron job

=head1 SYNOPSIS

	use App::Onsite::Support::CronHandler;
    my $obj = App::Onsite::Support::CronHandler->new(handler => 'SomePackage');
	$obj->run(@args);
